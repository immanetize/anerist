...
BLOG_AUTHOR = "Pete Travis"  # (translatable)
BLOG_TITLE = "the Anerist"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link
SITE_URL = "http://immanetize.github.io/anerist"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://getnikola.com/"
BLOG_EMAIL = "immanetize@fedoraproject.org"
BLOG_DESCRIPTION = "Some info about the Anerist project"  # (translatable)
